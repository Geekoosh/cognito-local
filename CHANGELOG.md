...
* fix!: user pool creation race conditions ([69ee1e1](https://github.com/Geekoosh/cognito-local/commit/69ee1e17f9daa2872660f33c538ee5bdf5443ef5))


### Bug Fixes

* add openid-configuration endpoint ([14a6507](https://github.com/Geekoosh/cognito-local/commit/14a65070dc6fe281f60452e612057dab4975a905))
* adminCreateUser correct response ([26aa5a7](https://github.com/Geekoosh/cognito-local/commit/26aa5a7f9a0dfb3cbd279f16e5e1a751f95aa810)), closes [#38](https://github.com/Geekoosh/cognito-local/issues/38)
* **api:** adminCreateUser defaults status to FORCE_CHANGE_PASSWORD ([4996aa4](https://github.com/Geekoosh/cognito-local/commit/4996aa418395db8fcd477fb3c26047ed21a1d4ce))
* **api:** adminCreateUser handles duplicate users ([7529971](https://github.com/Geekoosh/cognito-local/commit/752997144479f66168023604ee326e48c3e31fb3))
* **api:** adminDeleteUser handles email usernames ([8faa78f](https://github.com/Geekoosh/cognito-local/commit/8faa78f0aff3f642d806aa4d38530665d6593166)), closes [#99](https://github.com/Geekoosh/cognito-local/issues/99)
* **api:** confirm user apis return errors for invalid states ([e2975f0](https://github.com/Geekoosh/cognito-local/commit/e2975f0218ea64f25024923f74bfa9a69e90fb8c))
* **api:** createUserPool saves SchemaAttributes ([3301878](https://github.com/Geekoosh/cognito-local/commit/3301878e8d45296717992c6ad566fd5b17687a49)), closes [#93](https://github.com/Geekoosh/cognito-local/issues/93)
* **api:** finish implementation of changePassword ([f649bfa](https://github.com/Geekoosh/cognito-local/commit/f649bfa8f8a14345268e3cd25560ccdbaace8a5d))
* **api:** initiateAuth throws when missing AuthParameters ([d1eb240](https://github.com/Geekoosh/cognito-local/commit/d1eb240329dca39dcda4a8d080b94cec8822b331))
* **api:** respond with x-amz-json content type ([8ecaf40](https://github.com/Geekoosh/cognito-local/commit/8ecaf40208c513c91cf5e37354104103101a7e95)), closes [#404](https://github.com/Geekoosh/cognito-local/issues/404)
* **api:** respondToAuthChallenge throws if missing ChallengeResponses ([5e5aa36](https://github.com/Geekoosh/cognito-local/commit/5e5aa36740cff3cf37ec316e8a206e5a84f3022f))
* **api:** save attribute code separately from confirmation code ([b18af6a](https://github.com/Geekoosh/cognito-local/commit/b18af6a75601c2dd9ab2f8f35c5df5fbd4bcf477))
* **api:** users can be queried by their sub ([ae555b8](https://github.com/Geekoosh/cognito-local/commit/ae555b88e0de24df370a309640a70e124c025392))
* **api:** verifyUserAttributes throws CodeMismatchError ([b3b116c](https://github.com/Geekoosh/cognito-local/commit/b3b116c306807a828fbc1e52629ee213c2fbfca8))
* auth_time resolution in generated tokens ([f300df4](https://github.com/Geekoosh/cognito-local/commit/f300df4fb42e6b8f28ed8b83770a5217efa6215f))
* **build:** publish npm packages ([faaf12b](https://github.com/Geekoosh/cognito-local/commit/faaf12b37aa74bd4c2db4f6c4d29d6172e0236d1))
* cache data stores to fix potential race condition ([406599a](https://github.com/Geekoosh/cognito-local/commit/406599acd787d8973ab5500a2e568b45d754dda1))
* change UserPoolId to Id in user pool storage ([71f5e52](https://github.com/Geekoosh/cognito-local/commit/71f5e524a249a0c17a3cd30af53205a1ba0c93e3))
* **ci:** allow Publish workflow to run via workflow_dispatch ([e6cd8e0](https://github.com/Geekoosh/cognito-local/commit/e6cd8e06d10bd6c143f62815dc90cca8990030fd))
* **ci:** use env context for secrets check in publish workflow ([35c6bde](https://github.com/Geekoosh/cognito-local/commit/35c6bde907a1a1d60956c6a815ef9dcb6ba3000b))
* **config:** arrays in config couldn't be overwritten ([7526a0a](https://github.com/Geekoosh/cognito-local/commit/7526a0aa4410420933b750bf08a912306dbca059))
* confirmation ode from 4-digit to 6-digit ([#194](https://github.com/Geekoosh/cognito-local/issues/194)) ([e2053fe](https://github.com/Geekoosh/cognito-local/commit/e2053fe2ad149c6aa1ec49b46b0eb10ef46dd0bd))
* conflation of a user's Sub and their Username ([ece63b6](https://github.com/Geekoosh/cognito-local/commit/ece63b6f037e25f3fae67003df59bc652d2ada79))
* **deps:** fix breaking change in stormdb ([dbed898](https://github.com/Geekoosh/cognito-local/commit/dbed8989153375ce0c48888650f0aea49feb096c))
* **errorFormat:** make exception format more consistent with real Cognito exceptions ([e67576b](https://github.com/Geekoosh/cognito-local/commit/e67576b85571a7d905be0e86c76aaec623ba5eb0))
* hide debug logging by default ([48de4e5](https://github.com/Geekoosh/cognito-local/commit/48de4e5be1e1a1c47768910355c3010e6923865d))
* imported json files weren't being published to npm ([5f76d86](https://github.com/Geekoosh/cognito-local/commit/5f76d8671cd8172eb94abe00e252ad4a511e7d47))
* include groups in tokens ([46e9445](https://github.com/Geekoosh/cognito-local/commit/46e94456859fe25031dddc42f2d8865979e72294)), closes [#176](https://github.com/Geekoosh/cognito-local/issues/176)
* include groups in tokens ([996dcde](https://github.com/Geekoosh/cognito-local/commit/996dcde4ebfa7b8d1d4825345aaaec645610144d)), closes [#176](https://github.com/Geekoosh/cognito-local/issues/176)
* incorrect case in import ([dd2538b](https://github.com/Geekoosh/cognito-local/commit/dd2538b48b7939b5772d0bb3a5b0d2e8bca101ae))
* **InitiateAuth:** handle UNCONFIRMED user login attempt ([93a452b](https://github.com/Geekoosh/cognito-local/commit/93a452b1f8ef72510554df29467402856aaddf08))
* **initiateAuth:** invoke post auth lambda before generating tokens ([8330a9f](https://github.com/Geekoosh/cognito-local/commit/8330a9f5dc247e3a9e63c6a0667fa8183c6f3a7c)), closes [#281](https://github.com/Geekoosh/cognito-local/issues/281)
* **initiateAuth:** invoke post auth lambda before generating tokens [281] ([8c06e2a](https://github.com/Geekoosh/cognito-local/commit/8c06e2aef43dccef11c46614a5f7575f6f3b4c95))
* **initiateAuth:** invoke post auth lambda before generating tokens [281] ([1b16f04](https://github.com/Geekoosh/cognito-local/commit/1b16f047ac18ce81a8e6d43e147d934b59e139d6))
* **jwt:** sign tokens with real rsa key ([949d3fc](https://github.com/Geekoosh/cognito-local/commit/949d3fcbad8e247047922580fe237e537bf50926))
* key setting in the datastore to work with arrays ([d0a2557](https://github.com/Geekoosh/cognito-local/commit/d0a25572de19b84e8228c1fea9d2ebbe9d40d160))
* lambda tests to use imported aws-sdk version ([d4a5c82](https://github.com/Geekoosh/cognito-local/commit/d4a5c82c6037392830ade18253bc3159d8f87619))
* **lambda:** customMessage uses code and username parameters ([084c253](https://github.com/Geekoosh/cognito-local/commit/084c2539126214ef1bc6e5d94b2a007b79c2f49a))
* **lambda:** forgotPassword invokes CustomMessage lambda ([79f43ef](https://github.com/Geekoosh/cognito-local/commit/79f43ef39830a33a012961cf2a37acf398bff1fd))
* **lambda:** invoke lambda with actual AWS SDK version ([bed1b7c](https://github.com/Geekoosh/cognito-local/commit/bed1b7c971f0f87891133151035a1d6960c2cf6b))
* **lambda:** lambda triggers called with clientMetadata/validationData ([2399c3e](https://github.com/Geekoosh/cognito-local/commit/2399c3eb7cbe92a772cdd0ec4082fb56b57fe3c6))
* **lambda:** preTokenGenerator can't change reserved claims ([407122f](https://github.com/Geekoosh/cognito-local/commit/407122fdfd5d973624c26aaba941fe8c6c783dce))
* **lambda:** save attributes from user migration lambda on user record ([dc7a1c6](https://github.com/Geekoosh/cognito-local/commit/dc7a1c6b2db2851760df106daededa9bf849a5d6))
* **lambda:** unhandled errors in lambda return correct error message ([c9821d1](https://github.com/Geekoosh/cognito-local/commit/c9821d1ae11f7fddc976f89451880439008c2005))
* **log:** errors not being logged correctly ([1ca2b99](https://github.com/Geekoosh/cognito-local/commit/1ca2b9948bb38b875601c3d7b6fdf481e963d2cb))
* propagate Session parameter through initiateAuth ([688fd4a](https://github.com/Geekoosh/cognito-local/commit/688fd4a476160fe9c99fbea19c5fd94e36d1a060))
* regression for usernames with full stops in ([73cb644](https://github.com/Geekoosh/cognito-local/commit/73cb644efb431e567b06f0b3b97b689f4b183e21)), closes [#35](https://github.com/Geekoosh/cognito-local/issues/35)
* **release:** reorder semantic-release plugins to commit last ([3a94c03](https://github.com/Geekoosh/cognito-local/commit/3a94c031d8699470f03a08b6fd5e85058b6a22f3))
* **release:** trigger a release for 1.0.0 ([5d8ba83](https://github.com/Geekoosh/cognito-local/commit/5d8ba83bff87009d4655570912ecddec4d4f6f9f))
* resolve pre-existing TypeScript errors in lambda, messages, and customMessage ([774aefd](https://github.com/Geekoosh/cognito-local/commit/774aefd7a5b47970866e1864c9fbc9dad9f119ad))
* restore full SchemaAttributes assertion in createUserPool test ([33be1f2](https://github.com/Geekoosh/cognito-local/commit/33be1f234456cb31ff244490f6ab03c8807681b3))
* runnable via npx ([4313ebf](https://github.com/Geekoosh/cognito-local/commit/4313ebf195514917800cfcdb928e914e08335587)), closes [#34](https://github.com/Geekoosh/cognito-local/issues/34)
* **server:** better default handling for HOST and PORT ([69b4648](https://github.com/Geekoosh/cognito-local/commit/69b4648977807d6491caa1243848c430d68f641b))
* sub as username when using emails ([045f507](https://github.com/Geekoosh/cognito-local/commit/045f5074dd331e572a0f9aa8faea9d81f44d2659))
* **tests:** newer node versions were starting express in ipv6 ([efc08a7](https://github.com/Geekoosh/cognito-local/commit/efc08a7d56024b4bdb22c4e1617a9f6b7e197acb))
* **tokens:** add jti to id and refresh tokens ([4f475ad](https://github.com/Geekoosh/cognito-local/commit/4f475ad5d2b5b92d30e7953809f80301ffe41944))
* **tokens:** adminInitateAuth uses token IssuerDomain ([37ba1c5](https://github.com/Geekoosh/cognito-local/commit/37ba1c557420340bf4a8cbcdb301b82b25f5cc2d))
* **tokens:** id token not using issuer config ([c488810](https://github.com/Geekoosh/cognito-local/commit/c4888103ac0d14b529c4ac3a83c3006765ae6b84))
* updating a user pool updates cached options ([dc2b10e](https://github.com/Geekoosh/cognito-local/commit/dc2b10ed1e19ede81ecc9b3d9d15e4e09ee5b72b))
* use username from user migration response ([0bb8d95](https://github.com/Geekoosh/cognito-local/commit/0bb8d952decbe8136485177ecc6e88fdabeb1a4e))
* use username from user migration response ([afe2372](https://github.com/Geekoosh/cognito-local/commit/afe23724dd91c1bc8de7b3d7deef8371eda22fcf))
* **userpool:** force save sub as attribute, fix sub check logic ([e5ed247](https://github.com/Geekoosh/cognito-local/commit/e5ed247d10fdf9411ec9ec8785301d18bc7aca5c))
* year out of range ([bc1fb6f](https://github.com/Geekoosh/cognito-local/commit/bc1fb6fb5b4e8f934784ec41d6246eeabfa28467)), closes [#40](https://github.com/Geekoosh/cognito-local/issues/40)


### Features

* add fetchAuthSession to demo app middleware ([1663cb6](https://github.com/Geekoosh/cognito-local/commit/1663cb6f67b66331a307141e5f0feb439bcb9e0b))
* add more admin features and change password ([6339917](https://github.com/Geekoosh/cognito-local/commit/63399177ab4dc7b891425f9d4dd5d2756a71c60d))
* add Region config to TokenConfig for Cognito-compatible issuer ([53cf334](https://github.com/Geekoosh/cognito-local/commit/53cf334e039c2a2e757d5e7d9a8cbdd96b842584))
* add support for admin commands ([b65a5bf](https://github.com/Geekoosh/cognito-local/commit/b65a5bf99192e0ef88bac371cb7935a2c8ad299f))
* add Team Status Board demo app for cognito-local integration testing ([226f817](https://github.com/Geekoosh/cognito-local/commit/226f817938e2cc34310d325e0d14a61ddb79ea63))
* **api:** adminConfirmSignUp full support ([e16a211](https://github.com/Geekoosh/cognito-local/commit/e16a2110eb1d707404eda6342d0178432e2f4875))
* **api:** adminCreateUser can generate a temporary password ([c0eea4f](https://github.com/Geekoosh/cognito-local/commit/c0eea4f0ad0d1352b1a0cdfcaa43f29a3afc69f2))
* **api:** adminCreateUser delivers welcome message ([d49aa80](https://github.com/Geekoosh/cognito-local/commit/d49aa8052bdd4605bdb79c697dc359116bdcfadf))
* **api:** adminDeleteUser full support ([58f33e2](https://github.com/Geekoosh/cognito-local/commit/58f33e20a312be8631279c1963a8cac39e3bbfda))
* **api:** adminDeleteUserAttributes full support ([1a47086](https://github.com/Geekoosh/cognito-local/commit/1a470866d889657c7415bc176defbb821ac30a47))
* **api:** adminGetUser full support ([a6fc4c8](https://github.com/Geekoosh/cognito-local/commit/a6fc4c834fb8f00b2fc068dbb368d2884880c584))
* **api:** adminSetUserPassword support ([1707257](https://github.com/Geekoosh/cognito-local/commit/1707257cc39bc2621b5b77520e61cc32c0ba5998))
* **api:** adminUpdateUserAttributes full support ([d3c5ebe](https://github.com/Geekoosh/cognito-local/commit/d3c5ebe3351166f8abf65490aa36621ab61ccd2a))
* **api:** basic listUsers support ([6e0c18f](https://github.com/Geekoosh/cognito-local/commit/6e0c18f162733b25fd3590bf1e87dc87d077e395))
* **api:** createGroup support ([c3dc092](https://github.com/Geekoosh/cognito-local/commit/c3dc0921ae116a356a9bee39df461795285f7c6b))
* **api:** createUserPool full support ([e5c08dc](https://github.com/Geekoosh/cognito-local/commit/e5c08dcb297cf75eaf07ffdda42a0addc8d4453e))
* **api:** deleteUser full support ([0a753b2](https://github.com/Geekoosh/cognito-local/commit/0a753b2301582a76f810a628582dc60d4f3a5ae3))
* **api:** deleteUserAttributes full support ([3d0e9a0](https://github.com/Geekoosh/cognito-local/commit/3d0e9a0c04740432d8bc6a3f128370566bc1aabc))
* **api:** describeUserPoolClient support ([26cf370](https://github.com/Geekoosh/cognito-local/commit/26cf370d38d83bc922431c68202a25d268402eb7))
* **api:** full support for groups ([1fc025c](https://github.com/Geekoosh/cognito-local/commit/1fc025cd664130124ccc4d077d5539420cc6d3f4))
* **api:** getUserAttributeVerificationCode full support ([90726a4](https://github.com/Geekoosh/cognito-local/commit/90726a42feb7537424562d97c0983c60450d7abd))
* **api:** initiateAuth handles FORCE_CHANGE_PASSWORD ([6703ea9](https://github.com/Geekoosh/cognito-local/commit/6703ea9a126852c921da9f23571c9ad776edc53b))
* **api:** listGroups support ([252ee96](https://github.com/Geekoosh/cognito-local/commit/252ee96f36a6ba9cd5456e3a4a8bc83341296ca5))
* **api:** listUserPools full support ([d2e5324](https://github.com/Geekoosh/cognito-local/commit/d2e53249395112c723bc02b1e0ca0dcc2910c896))
* **api:** listUsers support for Filter ([5ebcf24](https://github.com/Geekoosh/cognito-local/commit/5ebcf2460f57c1d3dfed8fa42969791aa58087da)), closes [#313](https://github.com/Geekoosh/cognito-local/issues/313)
* **api:** respondToAuthChallenge support ([842633e](https://github.com/Geekoosh/cognito-local/commit/842633ea779ceed39be78338d6ccd6f613c7e0c0))
* **api:** respondToAuthChallenge supports NEW_PASSWORD_REQUIRED ([6a75fea](https://github.com/Geekoosh/cognito-local/commit/6a75feae1ddc6122f35d7d3feee6a6a880e8d064))
* **api:** signUp delivers message using auto verified attributes ([64280e8](https://github.com/Geekoosh/cognito-local/commit/64280e851d7f9b18345f51cf51d7798687d5189c))
* **api:** sms_mfa support for initiateAuth ([f16afe6](https://github.com/Geekoosh/cognito-local/commit/f16afe60bcfad03ec960a0a6e5d3ccb594c38708))
* **api:** support for addCustomAttribute ([7932176](https://github.com/Geekoosh/cognito-local/commit/79321763c2401c82d119df24b1c931d0d1541889))
* **api:** support for CustomEmailSender ([5da5c7c](https://github.com/Geekoosh/cognito-local/commit/5da5c7c29bb1405936577767501b1ed8d3fb1c75))
* **api:** support for CustomEmailSender ([8dcaf10](https://github.com/Geekoosh/cognito-local/commit/8dcaf10bca72280be804bad3dd561711fd865191))
* **api:** support for DeleteUserPool ([9dd6f2d](https://github.com/Geekoosh/cognito-local/commit/9dd6f2dde124106f897d345d87658115d7baffdc))
* **api:** support for DeleteUserPoolClient ([f5bca87](https://github.com/Geekoosh/cognito-local/commit/f5bca879c0286e4814b116af75d00850f50511b3))
* **api:** support for ListUserPoolClients ([6e546ce](https://github.com/Geekoosh/cognito-local/commit/6e546ce6c7bcc6d711b41ab177ba40ed185401ee))
* **api:** support for UpdateUserPoolClient ([4fa9de5](https://github.com/Geekoosh/cognito-local/commit/4fa9de5b7a7dca21eac6d2945b9d9273a1fb27d0))
* **api:** support https ([c23eefe](https://github.com/Geekoosh/cognito-local/commit/c23eefec0becf3423ab618414039022526b59c5e))
* **api:** updateUserAttributes full support ([308c9c2](https://github.com/Geekoosh/cognito-local/commit/308c9c25de3292fa2632af69679af34f6c68586f))
* **api:** updateUserPool and describeUserPool support ([fc62e8f](https://github.com/Geekoosh/cognito-local/commit/fc62e8f6328863e8fde549aec73f40c8c27c457b))
* **api:** verifyUserAttribute full support ([320dd17](https://github.com/Geekoosh/cognito-local/commit/320dd172aaad98c841e69c00747c65f2dfd125cf))
* config file support ([ad0f247](https://github.com/Geekoosh/cognito-local/commit/ad0f2471f9ec73cb5668adf32560ea154570f801))
* confirm forgot password flow ([51df572](https://github.com/Geekoosh/cognito-local/commit/51df572d6be9e444f0cb330a8c6935b5788b2e32))
* **confirmationCodes:** add CODE environment variable to pre-define the confirmation codes ([2c823f0](https://github.com/Geekoosh/cognito-local/commit/2c823f0fe08c9d74754857f2433044d401ddb683))
* **confirmationCodes:** update README file ([9143469](https://github.com/Geekoosh/cognito-local/commit/9143469744a9eab86ac40e372e0be21992d1c503))
* createUserPoolClient support ([df421d7](https://github.com/Geekoosh/cognito-local/commit/df421d7ca83312f6b643d5ee9d3e9aa0bfff63a4))
* **docker:** publish arm64 images ([df0033b](https://github.com/Geekoosh/cognito-local/commit/df0033b0f4f9073916a0115ee75f2874893d6ba4))
* **docker:** publish arm64 images (again) ([c1361b8](https://github.com/Geekoosh/cognito-local/commit/c1361b85978a8b9158b7b4f3ff50f8a09095e34c))
* forgot password flow ([6bd0b42](https://github.com/Geekoosh/cognito-local/commit/6bd0b42ba04993859f775ab517bb41be9c06b0b4))
* include user attributes in user migration lambda call ([dabed92](https://github.com/Geekoosh/cognito-local/commit/dabed92182ff7dc5285ea21dbc042584b1ce2cd9))
* **jwt:** expose jwk endpoint to support verifying tokens ([bc27b86](https://github.com/Geekoosh/cognito-local/commit/bc27b867ff8eeabbeade3fcf983dd38d3b8953f7))
* **lambda:** initial user migration trigger support ([2f9ecfc](https://github.com/Geekoosh/cognito-local/commit/2f9ecfcf06738ae5d08013b0a96b71b48e852596))
* **lambda:** limited CustomMessage lambda support ([6880a90](https://github.com/Geekoosh/cognito-local/commit/6880a90423547162f44832adbc2267cad6890423))
* **lambda:** post authentication lambda support ([b75ca6b](https://github.com/Geekoosh/cognito-local/commit/b75ca6b70b91e09cf27d2ec2c56e1480b1818304))
* **lambda:** post confirmation lambda trigger ([f30573b](https://github.com/Geekoosh/cognito-local/commit/f30573b771109e7da28687805c6b7734f89fce80))
* **lambda:** postConfirmation called in signUp ([ddb2b77](https://github.com/Geekoosh/cognito-local/commit/ddb2b77bcf857b3e54213b2468c095671af60381))
* **lambda:** preSignUp trigger support in signUp ([af955a1](https://github.com/Geekoosh/cognito-local/commit/af955a1a5c093c8c9b3b9dd7821bfbb2a51243d9))
* **lambda:** preTokenGeneration trigger called when tokens generated ([d04506e](https://github.com/Geekoosh/cognito-local/commit/d04506e3623889fb96ffbb413cd97be627570aee))
* **lambda:** support for CustomMessage_Authentication ([dfb6fdf](https://github.com/Geekoosh/cognito-local/commit/dfb6fdffeda3e0519a0c7aba520ab718d6449cd9))
* **lambda:** support for CustomMessage_SignUp ([ce69ea7](https://github.com/Geekoosh/cognito-local/commit/ce69ea79d64f173bce43cb6d1bed340ba66ebf98))
* **server:** add hostname option ([0365f3a](https://github.com/Geekoosh/cognito-local/commit/0365f3acac5ff8a6541834ca26fbe04fdf176743))
* store clients for user pools ([eaad662](https://github.com/Geekoosh/cognito-local/commit/eaad66279346fbc8f5b8bb3b8ea6c9fd5d6882a8))
* support AttributesRequireVerificationBeforeUpdate ([a0d30eb](https://github.com/Geekoosh/cognito-local/commit/a0d30eb48e30f49b281d4878e71ecacf3a11af2f)), closes [#410](https://github.com/Geekoosh/cognito-local/issues/410) [#411](https://github.com/Geekoosh/cognito-local/issues/411)
* support configurable expiration for tokens ([bae6da5](https://github.com/Geekoosh/cognito-local/commit/bae6da5f4f05598f46067bd195bbf70e63607f31)), closes [#220](https://github.com/Geekoosh/cognito-local/issues/220)
* support configurable expiration for tokens ([675fab5](https://github.com/Geekoosh/cognito-local/commit/675fab504c1550d58d970b75a5fb57f228af6c4a)), closes [#220](https://github.com/Geekoosh/cognito-local/issues/220)
* support for adminEnable/DisableUser ([3b20f82](https://github.com/Geekoosh/cognito-local/commit/3b20f82ba263fc41aff5aa53ff6e68d65485da82))
* support for adminEnable/DisableUser ([462af6e](https://github.com/Geekoosh/cognito-local/commit/462af6eb13850ed34f325d6d1054c1b3c7a5b2dc))
* support for GetUser api ([cc8048b](https://github.com/Geekoosh/cognito-local/commit/cc8048b08d2937844e1bb3bcf5d966ed28b26465))
* support getUserPoolMfaConfig ([416ea1d](https://github.com/Geekoosh/cognito-local/commit/416ea1dd40be8db37ecec5f56484da36bd6d9374))
* suppress send welcome message ([12e7af8](https://github.com/Geekoosh/cognito-local/commit/12e7af8f51e416e3b43ee41ed6db3f8aba3b66b6))
* **token:** add refresh token, revoke token and initiate auth ([0d46ed7](https://github.com/Geekoosh/cognito-local/commit/0d46ed768fa6eb22c1ce1f404b7a366f1c341d0f))
* **token:** initiateAuth basic refresh token support ([2d6b0e3](https://github.com/Geekoosh/cognito-local/commit/2d6b0e362401e3414d3d49e2a60963dc492ce669))
* update openid-configuration endpoint to use configured issuer ([c01e27c](https://github.com/Geekoosh/cognito-local/commit/c01e27c0744f0d1a1c19a7f787d788bafb74b37b))
* use configured Region as user pool ID prefix ([fd0cfff](https://github.com/Geekoosh/cognito-local/commit/fd0cfffbcd1400872123565e7314bcbc54653d34))
